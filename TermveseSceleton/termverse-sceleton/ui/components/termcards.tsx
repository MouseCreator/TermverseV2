...
import {TermsProps} from "@/ui/data/data";
        ...
        <div>
            <div className="flex justify-center items-center text-3xl mb-4">
                <div className="p-2 overflow-hidden select-none">
                    <div
                    className="border-2 bg-white border-purple-500 shadow-lg rounded p-4 cursor-pointer w-[80vw] max-w-full h-[60vh] flex items-center justify-center"
