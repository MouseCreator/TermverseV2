...
@Service
public class OptionsAnnotationProcessor implements WebAnnotationProcessor{

    private final ControllerInvokerFactory controllerInvokerFactory;
    private final ContextFactory contextFactory;
    @Auto
    public OptionsAnnotationProcessor(ControllerInvokerFactory controllerInvokerFactory, ContextFactory contextFactory) {
    ...
    public Registration process(ControllerContext controller, Method method) {
        ...
        return new Registration(endpointContext.getUrl(), RequestMethod.OPTIONS, invoker);
    }
}
